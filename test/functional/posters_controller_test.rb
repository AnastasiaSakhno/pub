...
class PostersControllerTest < ActionController::TestCase
  ...
  test "should create poster" do
    assert_difference('Poster.count') do
      post :create, poster: { approximate_date: @poster.approximate_date, context: @poster.context, title: @poster.title, url: @poster.url }
    end
  ...
  test "should update poster" do
    put :update, id: @poster, poster: { approximate_date: @poster.approximate_date, context: @poster.context, title: @poster.title, url: @poster.url }
    assert_redirected_to poster_path(assigns(:poster))
  end
